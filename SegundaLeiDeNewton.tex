		...
		\begin{figure}[h]
			...
			\begin{tikzpicture}
				\begin{axis}[
					...
					scaled ticks=false, % Desabilita a notação científica
			...
			\begin{figure}[h!]
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						legend style={font=\small},
						scaled ticks=false, % Desabilita a notação científica
						tick label style={/pgf/number format/fixed}, % Usa notação decimal fixa
						yticklabel style={/pgf/number format/fixed}, % Especifica formatação fixa para o eixo Y
						]
